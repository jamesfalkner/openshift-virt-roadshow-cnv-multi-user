...
= Customize VirtualMachine Button

== Issue: Noticed the 'Customize VirtualMachine' button is not getting enabled on Module 5, windows 2019 vm creation from template lab section.
Am i missing/mis configuring anything here ?

=== Solution

its because you're in the openshift project and you can't actually create it there.
